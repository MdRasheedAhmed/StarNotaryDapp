...
contract StarNotary is ERC721 {
    ...
    string public constant name = "ERCrypt Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if(owner1 == msg.sender){
            ...
            revert ("Sender doesn't hold any token. Exchange not possible");
        }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
         require(msg.sender == ownerOf(_tokenId), "Star is not owned. Transfer not possible");
